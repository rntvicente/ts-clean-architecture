...
describe('#SignUp Controller', () => {
  ...
  test('Should return 400 when password confirmation fail', () => {
    const { sut } = makeSut()
  ...
  test('Should return 400 when invalid email is provided', () => {
  ...
  test('Should return 200 when valid is provided', () => {
    const { sut } = makeSut()
