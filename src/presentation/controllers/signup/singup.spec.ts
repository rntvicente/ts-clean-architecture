import { AddAccount, AddAccountModel, AccountModel, EmailValidator } from '.'
...
describe('#SignUp Controller', () => {
  ...
  test('Should return 400 when password confirmation fail', async () => {
    const { sut } = makeSut()
  ...
  test('Should return 200 when valid is provided', async () => {
    const { sut } = makeSut()
